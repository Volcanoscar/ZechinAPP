...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
	    ...
	    loadStringSetting(stmt, Settings.System.TIME_12_24, R.string.def_time_12_24);
             ...
             * See: SettingsProvider.UpgradeController#onUpgradeLocked
             */
			//lijun add for SmartGesture start
            loadBooleanSetting(stmt, Settings.System.SMART_GESTURE_CONTROL,R.bool.def_tpgesture_total_control);
            loadSetting(stmt, "w_choose_pkgName","com.android.chrome");
            loadSetting(stmt, "o_choose_pkgName","com.android.gallery3d");
            loadSetting(stmt, "m_choose_pkgName","com.google.android.music");
            loadSetting(stmt, "e_choose_pkgName","com.android.gallery3d");
            loadSetting(stmt, "c_choose_pkgName","com.android.dialer");
            loadSetting(stmt, "z_choose_pkgName","com.android.settings");
            loadSetting(stmt, "s_choose_pkgName","com.android.mms");
            loadSetting(stmt, "v_choose_pkgName","com.mediatek.videoplayer");
            loadSetting(stmt, "w_choose_activityName","com.google.android.apps.chrome.Main");
            loadSetting(stmt, "o_choose_activityName","com.android.camera.CameraLauncher");
            loadSetting(stmt, "m_choose_activityName","com.android.music.activitymanagement.TopLevelActivity");
            loadSetting(stmt, "e_choose_activityName","com.android.gallery3d.app.GalleryActivity");
            loadSetting(stmt, "c_choose_activityName","com.android.dialer.DialtactsActivity");
            loadSetting(stmt, "z_choose_activityName","com.android.settings.Settings");
            loadSetting(stmt, "s_choose_activityName","com.android.mms.ui.BootActivity");
            loadSetting(stmt, "v_choose_activityName","com.mediatek.videoplayer.MovieListActivity");
            //lijun add for SmartGesture end
        } finally {
            if (stmt != null) stmt.close();
        }
    }
